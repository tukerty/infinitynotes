import { Component, EventEmitter, Injectable, Input, NgModule, Optional } from '@angular/core';
...
var Angular2TokenService = /** @class */ (function () {
    ...
    Angular2TokenService.prototype.request = function (options) {
        ...
        var /** @type {?} */ response = this.http.request(new Request(baseRequestOptions)).share();
    ...
    Angular2TokenService.prototype.requestCredentialsViaPostMessage = function (authWindow) {
        var /** @type {?} */ pollerObserv = Observable$1.interval(500);
        var /** @type {?} */ responseObserv = Observable$1.fromEvent(window, 'message').pluck('data')
...
var a2tRoutes = RouterModule.forChild(routes);
...
//# sourceMappingURL=angular2-token.es5.js.map
